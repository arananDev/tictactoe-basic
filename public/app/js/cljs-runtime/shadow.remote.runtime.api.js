...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13640 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13640(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13641 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13641(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_13643 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_13643(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13646 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13646(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13651 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13651(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13652 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13652(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13631,callback){
var map__13632 = p__13631;
var map__13632__$1 = cljs.core.__destructure_map(map__13632);
var input = map__13632__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13632__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13632__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
