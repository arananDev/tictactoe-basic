...
var i_13468 = (0);
while(true){
if((i_13468 < arr.length)){
(arr[i_13468] = null);

var G__13469 = (i_13468 + (1));
i_13468 = G__13469;
continue;
} else {
}
...
var i_13483 = (self__.level + (1));
while(true){
if((i_13483 <= (new_level + (1)))){
(update[i_13483] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_13485 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13485[i]));
} else {
x__$2.forward.push((((i < links_13485.length))?(links_13485[i]):null));
}

if((i < links_13485.length)){
(links_13485[i] = x__$2);
} else {
links_13485.push(x__$2);
}
...
var i_13487 = (0);
while(true){
if((i_13487 <= self__.level)){
var links_13488 = (update[i_13487]).forward;
if((x__$1 === (((i_13487 < links_13488.length))?(links_13488[i_13487]):null))){
(links_13488[i_13487] = (x__$1.forward[i_13487]));

var G__13490 = (i_13487 + (1));
i_13487 = G__13490;
continue;
} else {
var G__13491 = (i_13487 + (1));
i_13487 = G__13491;
continue;
}
} else {
...
var G__13494 = nx;
var G__13495 = (level__$1 - (1));
x = G__13494;
level__$1 = G__13495;
continue;
} else {
var G__13496 = x;
var G__13497 = (level__$1 - (1));
x = G__13496;
level__$1 = G__13497;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__13499 = nx;
var G__13500 = (level__$1 - (1));
x = G__13499;
level__$1 = G__13500;
continue;
} else {
var G__13501 = x;
var G__13502 = (level__$1 - (1));
x = G__13501;
level__$1 = G__13502;
continue;
}
