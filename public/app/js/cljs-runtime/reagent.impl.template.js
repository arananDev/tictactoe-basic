...
var G__11754 = o;
reagent.impl.template.goog$module$goog$object.set(G__11754,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__11755 = o;
reagent.impl.template.goog$module$goog$object.set(G__11755,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__11776__i < G__11776__a.length) {G__11776__a[G__11776__i] = arguments[G__11776__i + 0]; ++G__11776__i;}
  args = new cljs.core.IndexedSeq(G__11776__a,0,null);
} 
...
var G__11756 = props;
var G__11756__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11756,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11756);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11756__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__11757 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11757,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__11757;
}
})(),id_class);
...
var G__11758 = (cljs.core.count(argv) - first_child);
switch (G__11758) {
case (0):
...
var vec__11759 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11759,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11759,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11759,(2),null);
...
var temp__5808__auto___11779 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11779 == null)){
} else {
var key_11780 = temp__5808__auto___11779;
(jsprops.key = key_11780);
}
...
var temp__5808__auto___11781 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11781 == null)){
} else {
var key_11782 = temp__5808__auto___11781;
(jsprops.key = key_11782);
}
...
var temp__5808__auto___11787 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___11787 == null)){
} else {
var key_11789 = temp__5808__auto___11787;
...
var temp__5808__auto___11800 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11800 == null)){
} else {
var key_11802 = temp__5808__auto___11800;
(jsprops.key = key_11802);
}
...
var temp__5808__auto___11806 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11806 == null)){
} else {
var key_11808 = temp__5808__auto___11806;
(jsprops.key = key_11808);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11762_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__11762_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__11763 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11763,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11763,(1),null);
...
break;
default:
var G__11816 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__11817 = compiler;
v = G__11816;
compiler = G__11817;
continue;
...
var G__11767 = tag;
var G__11767__$1 = (((G__11767 instanceof cljs.core.Keyword))?G__11767.fqn:null);
switch (G__11767__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template11769 = (function (opts,id,fn_to_element,parse_fn,meta11770){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta11770 = meta11770;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template11769.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11771,meta11770__$1){
var self__ = this;
var _11771__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template11769(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta11770__$1));
}));

(reagent.impl.template.t_reagent$impl$template11769.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11771){
var self__ = this;
var _11771__$1 = this;
return self__.meta11770;
}));

(reagent.impl.template.t_reagent$impl$template11769.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11769.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template11769.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template11769.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template11769.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template11769.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta11770","meta11770",-784125811,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template11769.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template11769.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template11769");

(reagent.impl.template.t_reagent$impl$template11769.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template11769");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template11769.
 */
reagent.impl.template.__GT_t_reagent$impl$template11769 = (function reagent$impl$template$__GT_t_reagent$impl$template11769(opts,id,fn_to_element,parse_fn,meta11770){
return (new reagent.impl.template.t_reagent$impl$template11769(opts,id,fn_to_element,parse_fn,meta11770));
});
...
return (new reagent.impl.template.t_reagent$impl$template11769(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
